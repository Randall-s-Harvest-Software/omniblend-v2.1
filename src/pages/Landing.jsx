    ...
    return (
        ...
        >
            ...
            <AnimatePresence>
                {isMenuOpen && (
                    <motion.div
                        ...
                        className="sm:hidden absolute top-16 left-0 w-full bg-[#571111]/95 backdrop-blur-lg border-t border-white/10 shadow-lg z-40"
                    >
            ...
            <main className="flex-1 flex items-center justify-center relative mt-20 sm:mt-0">
                <div className="relative flex justify-center items-center w-full">
                    ...
                    <motion.img
                        ...
                        className={`relative w-[250px] xs:w-[300px] sm:w-[330px] lg:w-[500px] top-24 xs:top-28 sm:top-32 h-auto z-20 ${
                            isExiting ? "" : "animate-drop-then-float"
                        }`}
                        initial={false}
                        animate={isExiting ? { scale: 1.6, opacity: 0, y: 220 } : {}}
                        transition={
                            isExiting ? { duration: 1.1, ease: "easeIn" } : {}
                        }
                        onAnimationComplete={() => {
                            if (isExiting) {
              ...
              <span className="text-[10px] xs:text-[12px] sm:text-[18px] lg:text-[20px]">
                85 g
              </span>
                        </div>
                    </div>
